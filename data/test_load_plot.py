...
path = "/Users/wan410/Documents/VSCode/torch-cfd/data/McWilliams2d_fp64_128x128_N2_Re1e+04_T100.pt"
if os.path.exists(path):
    with open(path, 'rb') as f:
        data = pickle.load(f)
else:
    with open("data/fnodata_extra_64x64_N2_v1e-3_T50_steps100_alpha2.5_tau7.pt", 'rb') as f:
        data = pickle.load(f)
...
mp4_path = 'vorticity_animation.mp4'
try:
